...
<html lang="en">
  <head>
    ...
    <title>Daily Shop | Product Page</title>
             ...
             <form action="">
               <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                    <c:forEach items="${cval}" var="cat">
                      <tr>                     
                        <td><img src="${cat.imgpath}" alt="img"></td>
                        <td>${cat.name}</td>
                        <td><span>&#8377;</span> ${cat.amt}</td>
                        <td><input class="aa-cart-quantity" type="number" value="${cat.aqty}"></td>     
                      </tr>
                      </c:forEach>                                      
                      </tbody>
                  </table>
