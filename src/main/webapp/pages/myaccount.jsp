            ...
            <div class="row">
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 <h4>Register</h4>
                 <form action="update" class="aa-login-form" method="post">
                    <label for="">Full Name<span>*</span></label>
                    <input type="text" name="name" value="${accdetails.name}" readonly required>
                    <label for="">Mobile Number<span>*</span></label>
                    <input type="text" name="mno" value="${accdetails.mno}" required maxlength="10">
                    <label for="">Date of Birth<span>*</span></label>
                    <input type="date" name="dob" value="${accdetails.dob}" required></br>
