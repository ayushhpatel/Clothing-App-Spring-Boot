             ...
             <form action="">
               <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td><a class="remove" href="rmvcart?name=${name}"><fa class="fa fa-close"></fa></a></td>
                        <td><a href="#"><img src="${cartdetails.imgpath}" alt="img"></a></td>
                        <td><a class="aa-cart-title" href="#">${cartdetails.name}</a></td>
                        <td>${cartdetails.amt}</td>                                            
                      </tr>                    
                      </tbody>
                  </table>
                </div>
